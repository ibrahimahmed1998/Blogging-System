       ...
       function myFunction()
        {
            ...
            if( x.style.display === "none"){ x.style.display = "block";   } /// appper
            else{ x.style.display = "none";}

            if( y.style.display === "none"){ y.style.display = "block";} /// appper
    ...
    <header class="site-navbar" role="banner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-center links">Haven't account?<a href="/s">Sign Up</a></div>
     ...
     <script type="text/javascript">
        $('#submit').click(function(event){
            ...
            if (email1 == "") { alert("email1 must be filled out");  return false;    }
            if (pass == "") { alert("pass must be filled out");  return false;    }
        ...
        // $.ajaxSetup({  headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') } });
            ...
            $.ajax({
                ...
                success:function(response) {  console.log(response);  alert('Login Successfully ^_^ ') ;   var w = window.open('/')  },
